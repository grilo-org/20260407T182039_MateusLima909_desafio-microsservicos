...
* The original package name 'edu.mateus.catalogoprodutos.discovery-service' is invalid and this project uses 'edu.mateus.catalogoprodutos.discovery_service' instead.
